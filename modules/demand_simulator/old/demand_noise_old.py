...
class DemandNoiseGenerator:
    ...
    def _generate_discount_matrix(
        ...
        En cada iteración r:
            ...
            score[h,d] = W[h,d] * (G[h,d] - R_r[h,d])

        donde:
            G = C

        Luego se selecciona una celda con probabilidad proporcional al score
        y se le suma 1 unidad de descuento.
        """
        ...
        for _ in range(discount_total):
            ...
            selection_score = discount_weights * remaining_capacity
